locals {
  ...
  default_crucible_spark_image          = local.crucible_image_registry != "" ? "${local.crucible_image_registry}/ziplineai/spark:3.5-crucible-latest" : "ziplineai/spark:3.5-crucible-latest"
